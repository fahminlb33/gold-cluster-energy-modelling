...
python tune.py --split_method random --model_name extra-trees
...
python tune.py --split_method kennard_stone --model_name extra-trees
...
python tune.py --split_method kmeans --model_name extra-trees
